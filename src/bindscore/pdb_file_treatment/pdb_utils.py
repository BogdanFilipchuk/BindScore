...
def get_protein_from_pdb(pdb_path:pathlib.Path)->pathlib.Path:
    ...
    with open(only_protein_file_path,"w") as file:
        file.write("\n".join(only_protein_lines) + "\nEND\n")     #Apparently FREESasa module requires this as a part of the pdb file structure.
    return only_protein_file_path


get_ligand_from_pdb(pathlib.Path(r"C:\Users\bogfi\VScode\6PYH.pdb"))
get_protein_from_pdb(pathlib.Path(r"C:\Users\bogfi\VScode\6PYH.pdb"))