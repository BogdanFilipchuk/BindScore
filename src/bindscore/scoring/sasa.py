...
#This module calculates the solvent available surface area contribution to entropy. It uses FreeSASA module, available at 
...
def getsasa(pdb_path:pathlib.Path)->float:
    ...
    sasa_complex  = sasa.calc(sasa.Structure(str(pdb_path)))       # both chains together
